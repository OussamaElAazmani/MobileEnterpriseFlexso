sap.ui.define([
	...
	return BaseObject.extend("be.ehb.mobile.EnterpriseFlexso.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias be.ehb.mobile.EnterpriseFlexso.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "Lastname");
			}
