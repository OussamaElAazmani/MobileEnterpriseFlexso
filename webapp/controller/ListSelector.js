sap.ui.define([
	...
	return BaseObject.extend("be.ehb.mobile.EnterpriseFlexso.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias be.ehb.mobile.EnterpriseFlexso.model.ListSelector
		 */
		 ...
		 * @return {be.ehb.mobile.EnterpriseFlexso.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
