sap.ui.define([
	...
	return BaseController.extend("be.ehb.mobile.EnterpriseFlexso.controller.CreateEntity", {
		...
		_navBack: function () {
			...
			if (sPreviousHash !== undefined) {
				...
				this.getRouter().getTargets().display("project");
			}
		},
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("ProjectOdataSet", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("ProjectOdataSet", oData);
