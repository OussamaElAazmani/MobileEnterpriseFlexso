...
sap.ui.define([
	...
	return BaseController.extend("be.ehb.mobile.EnterpriseFlexso.controller.Detail", {
		...
		onDelete: function () {
			...
			var oViewModel = this.getModel("detailView"),
				...
				sObjectHeader = this._oODataModel.getProperty(sPath + "/Lastname"),
		...
		_onObjectMatched: function (oEvent) {
			...
			this.getModel().metadataLoaded().then(function () {
				var sObjectPath = this.getModel().createKey("EmployeeOdataSet", oParameter);
